...
class RealDriver(Node):
    def __init__(self, robot="go2", internal_policy=None, obs_dim=45):
        ...
        self.get_logger().info(f"[RealDriver] Initialized for {robot}. Ready for deployment.")
    ...
    def control_loop(self):
        ...
        # 1. Standardize State via TelemetryManager
        # We need to map SDK2 LowState to our StandardState
        # SDK2 state order is usually 0-2 (FR), 3-5 (FL), 6-8 (RR), 9-11 (RL)
        # Our StandardState expects [FL, FR, RL, RR] type-grouped
    ...
    def send_to_sdk(self, joint_targets):
        ...
        ros_to_sdk = [1, 5, 9, 0, 4, 8, 3, 7, 11, 2, 6, 10] # This needs to be carefully verified for SDK2
