...
class QuadrupedEnvCfg(DirectRLEnvCfg):
    ...
    # Handstand Rewards
    rew_scale_alive = 2.0
    rew_scale_handstand_orientation_exp = 10.0
    rew_scale_handstand_height_exp = 5.0
    rew_scale_track_lin_vel_xy_exp = 5.0
    rew_scale_front_feet_contact = 1.0
    rew_scale_hind_feet_air = 1.0
    command_lin_vel_std = 0.3
    rew_scale_lin_vel_l2 = -0.1
    rew_scale_ang_vel_l2 = -0.1
    rew_scale_joint_vel_l2 = -0.01
    rew_scale_dof_pos_l2 = -0.1
    rew_scale_dof_torques_l2 = -0.0001
    rew_scale_dof_acc_l2 = -1e-7
    ...
    base_angle_termination_thresh = (
        0.0  # Relaxed for handstand: allows base-z to be horizontal
    )
