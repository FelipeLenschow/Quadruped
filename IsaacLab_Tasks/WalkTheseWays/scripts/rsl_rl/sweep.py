...
Why this exists rather than reusing the MuJoCo sweep: walk_these_ways's actor has NO
...
plot on one axis.
    ...
    python scripts/rsl_rl/sweep.py --task=Go2-WTW --headless \
        --checkpoint logs/rsl_rl/go2_wtw/2026-09-25_02-39-07/model_22000.pt
"""
