...
class TorqueSpeedActuator(DelayedPDActuator):
    """Delayed PD actuator with a torque-speed curve.
    ...
    def __init__(self, cfg: TorqueSpeedActuatorCfg, *args, **kwargs):
...
@configclass
class TorqueSpeedActuatorCfg(DelayedPDActuatorCfg):
    """
    Configuration for the torque-speed actuator.
    """

    class_type: type = TorqueSpeedActuator
...
@configclass
class Go2ActuatorCfg(TorqueSpeedActuatorCfg):
    X1 = 13.5
    X2 = 30
    Y1 = 20.2
    Y2 = 23.4
