...
"""Configuration for the Unitree Go2.
...
from simple.assets.robots import unitree_actuators

UNITREE_MODEL_DIR = "/home/05680435969@corp.udesc.br/unitree_model"  # Replace with the actual path to your unitree_model directory
...
class UnitreeUrdfFileCfg(sim_utils.UrdfFileCfg):
    ...
    def replace_asset(self, meshes_dir, urdf_path):
        ...
        """
        tmp_meshes_dir = "/tmp/IsaacLab/simple/meshes"
        if os.path.exists(tmp_meshes_dir):
            os.remove(tmp_meshes_dir)
        os.makedirs("/tmp/IsaacLab/simple", exist_ok=True)
        os.symlink(meshes_dir, tmp_meshes_dir)

        self.asset_path = "/tmp/IsaacLab/simple/robot.urdf"
...
UNITREE_GO2_CFG = UnitreeArticulationCfg(
    ...
    spawn=UnitreeUsdFileCfg(
        # The local Unitree_Go2/usd/go2.usd in this workspace is an unfetched Git LFS
