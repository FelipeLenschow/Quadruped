...
3.  **Initialization**: Update `quadruped_core/controller/pose_generator.py` to instantiate the model:
    ```python
...
*   **`quadruped_drivers/real_driver.py`**:
    ```python
    # In send_to_sdk()
...
*   **`quadruped_drivers/mujoco_driver.py`**:
    ```python
    # In _pd_torques()
