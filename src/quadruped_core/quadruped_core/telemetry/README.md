...
Pure-NumPy FK and Jacobians for the Unitree Go2, geometry from `quadruped_description/config/go2_kinematics.yaml`.
...
### 4. Kinematics Config (`quadruped_description/config/go2_kinematics.yaml`)
...
## Configuration (`quadruped_bringup/config/config.yaml`)
