...
Geometry is loaded from quadruped_description/config/go2_kinematics.yaml, which was extracted from
the official MuJoCo model (quadruped_description/mujoco_menagerie/unitree_go2/go2.xml).
...
def _load_kin_config() -> dict:
    """Return the go2_kinematics sub-dict from quadruped_description/config/go2_kinematics.yaml."""
    cfg_path = paths.description("config", "go2_kinematics.yaml")
...
class Go2Kinematics:
    ...
    Geometry is loaded at import time from quadruped_description/config/go2_kinematics.yaml.
