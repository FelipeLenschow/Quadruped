...
from quadruped_core.controller.policy_runner import PolicyRunner, PolicyMLP, RunningStandardScaler
import argparse
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", type=str, default=paths.repo("src", "quadruped_description", "policies", "policy_jit.pt"), help="Output path")
