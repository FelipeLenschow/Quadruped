...
from quadruped_drivers.foot_contact_overlay import FootContactOverlay, FOOT_NAMES
...
class MujocoTwinNode(Node):
    ...
    def __init__(self, robot_type="go2", use_estimator=False, show_ghost=True):
        ...
        # 1. Load MuJoCo Model
        menagerie_dir = paths.description("mujoco_menagerie", "unitree_go2")
        ...
        # own FSR, and this machine's quadruped_bringup/config/config.yaml is not the robot's.
    ...
    def foot_calibration_cb(self, msg: Float32MultiArray):
        ...
        self.get_logger().info(
            ...
            "  (the local quadruped_bringup/config/config.yaml does not decide this)")
